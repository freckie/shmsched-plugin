...
func autoConvert_v1beta2_NodeResourceTopologyMatchArgs_To_config_NodeResourceTopologyMatchArgs(in *NodeResourceTopologyMatchArgs, out *config.NodeResourceTopologyMatchArgs, s conversion.Scope) error {
	// WARNING: in.ScoringStrategy requires manual conversion: inconvertible types (*github.com/freckie/shmsched-plugin/apis/config/v1beta2.ScoringStrategy vs github.com/freckie/shmsched-plugin/apis/config.ScoringStrategy)
	return nil
}
...
func autoConvert_config_NodeResourceTopologyMatchArgs_To_v1beta2_NodeResourceTopologyMatchArgs(in *config.NodeResourceTopologyMatchArgs, out *NodeResourceTopologyMatchArgs, s conversion.Scope) error {
	// WARNING: in.ScoringStrategy requires manual conversion: inconvertible types (github.com/freckie/shmsched-plugin/apis/config.ScoringStrategy vs *github.com/freckie/shmsched-plugin/apis/config/v1beta2.ScoringStrategy)
	return nil
}
